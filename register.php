...
<table>
    <form method="post" action=<?= $_SERVER['REQUEST_URI']; ?> enctype="multipart/form-data" name="registerForm" onsubmit="return(validate());"<br>
        <tr>
            <td>Voornaam:</td>
            <td><input type="text" name="first" placeholder="Voornaam" value="<?= (isset($first) ? $first : ''); ?>"/></td>
        </tr>
        <tr>
            <td>Achternaam</td>
            <td><input type="text" name="last" placeholder="Achternaam" value="<?= (isset($last) ? $last : ''); ?>"/></td>
        </tr>
        <tr>
            <td>E-mail</td>
            <td><input type="email" name="email" placeholder="E-mail"value="<?= (isset($email) ? $email : ''); ?>"/></td>
        <tr>
            <td>Wachtwoord</td>
        ...
        <tr>
            ...
            <td><input type="date" name="date" min="<?php date("d/m/y") ?>"value="<?= (isset($date) ? $date : ''); ?>"/></td>
        </tr>
        <tr>
            <td>Captcha</td>
